                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-12 mt_md--40 mt_sm--40">
                    <div class="footer-widget widget-information">
                        ...
                        <ul class="footer-list-one">
                            ...
                            <li class="single-list"><a href="{{ route('home') }}">Blog Grid</a></li>
                            <li class="single-list"><a href="{{ route('home') }}">About Us</a></li>
                    ...
                    <div class="footer-widget">
                        ...
                        <ul class="footer-recent-post">
                            <li class="recent-post">
                                ...
                                <div class="content">
                                    <h6 class="title"><a href="{{ route('home') }}">#21 The Wonder</a></h6>
                            ...
                            <li class="recent-post">
                                ...
                                <div class="content">
                                    <h6 class="title"><a href="{{ route('home') }}">Diamond Dog</a></h6>
                                    <p>Highest bid 1/20</p>
                            ...
                            <li class="recent-post">
                                ...
                                <div class="content">
                                    <h6 class="title"><a href="{{ route('home') }}">Morgan11</a></h6>
                                    <p>Highest bid 1/20</p>
