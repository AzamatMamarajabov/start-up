                              ...
                              <div class="card overflow-hidden">
                                   <div class="card-body">
                                        <div class="bg-primary profile-bg rounded-top position-relative mx-n3 mt-n3">
                                             <img src="{{ asset($user->profile_image ?? 'assets/images/icons/boy-avater.png') }}" alt="" class="avatar-xl border border-light border-3 rounded-circle position-absolute top-100 start-0 translate-middle ms-5">
                                        </div>
                                        <div class="mt-5 d-flex flex-wrap align-items-center justify-content-between">
                                             <div>
                                                  <h4 class="mb-1">{{$user->firstname}} {{$user->lastname}} <i class='bx bxs-badge-check text-success align-middle'></i></h4>
